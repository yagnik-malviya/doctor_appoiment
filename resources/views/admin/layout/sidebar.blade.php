    ...
    <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <ul id="category" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('admin.category.add') }}">
                        <i class="bi bi-circle"></i><span>Category Add</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.category.list') }}">
                        <i class="bi bi-circle"></i><span>Category View</span>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul id="doctor" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('admin.doctor.add') }}">
                        <i class="bi bi-circle"></i><span>Doctor Add</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.doctor.list') }}">
                        <i class="bi bi-circle"></i><span>Doctor View</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#appoiment" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Appoiment</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="appoiment" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('admin.appoiment.add') }}">
                        <i class="bi bi-circle"></i><span>Appoiment Add</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.appoiment.list') }}">
                        <i class="bi bi-circle"></i><span>Appoiment View</span>
                    </a>
                </li>
            </ul>
        </li>
